...
const navItems = [
  ...
  { to: '/supplier-requests', icon: '📡', label: 'Supplier Status', section: 'OVERVIEW', roles: ['RETAILER', 'DISTRIBUTOR'] },
  { to: '/incoming-shipments', icon: '📦', label: 'Incoming Shipments', section: 'OVERVIEW', roles: ['RETAILER', 'DISTRIBUTOR'] },
  { to: '/supplier-incoming', icon: '📥', label: 'Client Orders',   section: 'OVERVIEW', roles: ['SUPPLIER'] },
